...
<head>
	  ...
	  <style>
		  ...
		  .ui.green1.buttons .button,
		  .ui.green1.button {
 			background-color: #53c68c;
  			color: #FFFFFF;
  			text-shadow: none;
		  }
		  .ui.orange1.buttons .button,
		  .ui.orange1.button {
...
<body>
	...
	<div class="ui inverted segment" style="background-color:#53c68c;">
	    ...
	    <div class="ui buttons">
	    	<div class="ui huge action input" >
		    	<input type="text huge" placeholder="Search for a car in town, postcode etc." style="width: 550px;">
		  		...
		  		<button class="ui orange1 button big" >
					<i class="search icon "></i>ค้นหา</button>
		  		<div class="or" style="width: 550px;"></div>
		  		<button class="ui green1 button big" > 
			      	<i class="crosshairs icon"></i>ค้นหาอู่ใกล้เคียง</button>
    ...
    <div >
    	<h1 class="ui horizontal header divider container">
        	<a>ง่ายๆใน 3 ขั้นตอน</a>
      	</h1>
    </div><br>
    <div class="ui container">
    ...
    <div class="ui inverted vertical footer segment" style="background-color:#53c68c;">
    	<div class="ui container">
      		<div class="ui stackable inverted divided equal height stackable grid">
        		<div class="four wide column">
